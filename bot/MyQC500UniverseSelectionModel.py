...
class MyQC500UniverseSelectionModel(FundamentalUniverseSelectionModel):
    '''Defines the QC500 universe as a universe selection model for framework algorithm
    For details: https://github.com/QuantConnect/Lean/pull/1663'''

    def __init__(self, filterFineData = True, universeSettings = None, securityInitializer = None):
        '''Initializes a new default instance of the MyQC500UniverseSelectionModel'''
    ...
    def SelectCoarse(self, algorithm, coarse):
        if algorithm.universeAmt > 0: self.numberOfSymbolsFine = algorithm.universeAmt
        ...
        sortedByDollarVolume = sorted([x for x in coarse if x.HasFundamentalData and (x.Volume > 0) and (x.Price > 0) and (x.Price < algorithm.maxPrice)],
